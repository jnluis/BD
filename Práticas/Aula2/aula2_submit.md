...
Produto: 
    - Código, Nome, Preço, Taxa do IVA, Número de produtos em armazém
...
Fornecedor:
    - NIF, Nome, Endreço, Condições de Pagamento, Número de Fax

Tipo de Fornecedor:
    - Código interno, Designação

Relacionamentos:
    - O armazém tem um certo número de unidades de cada produto.
    - Uma encomenda contém 1 ou mais produtos.
    - Uma encomenda possui apenas 1 fornecedor.
    - Um fornecedor pode fornecer para várias encomendas.
    - Um fornecedor percetence a um certo tipo de fornecedor.
